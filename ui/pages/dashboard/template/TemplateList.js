...
// sections
import { TemplateTableRow, TemplateTableToolbar } from '../../../sections/@dashboard/template-list';
...
export default function TemplateList({ templateList, isLoading, onDelete }) {
  ...
  const handleEditRow = (id) => {
    navigate(PATH_DASHBOARD.template.edit(id));
  };
  ...
  return (
    <Card>
      <TemplateTableToolbar filterName={filterName} onFilterName={handleFilterName} />
